...
CREATE TABLE `band` (
  ...
  `instruement` varchar(30) NOT NULL,
  `band_hours` decimal(3,2) DEFAULT NULL,
  PRIMARY KEY (`ID_band`),
  CONSTRAINT `students_fk_band` FOREIGN KEY (`ID_band`) REFERENCES `students` (`ID_student`)
...
INSERT INTO `band` VALUES (1,'Violin',2.25),(2,'Flute',2.25);
